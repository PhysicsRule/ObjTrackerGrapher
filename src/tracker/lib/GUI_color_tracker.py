...
## Infrared tracking by subtracting the original scene was done in the past, so remonents of these features are still present.
...
def GUI_color_tracking(src, type_of_tracking, image,color_ranges, min_radius_of_object, data_output_folder_path):
